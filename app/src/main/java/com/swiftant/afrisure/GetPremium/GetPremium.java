package com.swiftant.afrisure.GetPremium;
...
import com.swiftant.afrisure.GetPremium.adapter.GetPremiumAdapter;
...
public class GetPremium extends AppCompatActivity {
    ...
    private void assignValues() {
        try {
            if (flowDetails != null) {
                detailsLayout.setVisibility(View.
                        VISIBLE
                );
                lineOfBusinessTv.setText(flowDetails.lineOfBusiness);
                if (flowDetails.products.size() == 1) {
                    productsTitleTv.setVisibility(View.
                            GONE
                    );
                    productTitleTv.setVisibility(View.
                            VISIBLE
                    );
